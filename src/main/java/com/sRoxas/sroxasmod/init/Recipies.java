...
public class Recipies
{
    ...
    {
        // Misc Items
        craftManager.addShapelessRecipe(new ItemStack(ModBlocks.BambooPlanks, 16), new Object[]{Blocks.log, Blocks.log});
        ...
        craftManager.addRecipe(new ItemStack(ModBlocks.BlockOfReinforcedDiamondEncrustedIron, 1), new Object[] {"OIO", "IDI", "OIO", 'I', new ItemStack(ModItems.reinforcedIronIngot), 'D', new ItemStack(ModItems.reinforcedDiamond), 'O', new ItemStack(Blocks.obsidian)});
        craftManager.addRecipe(new ItemStack(ModBlocks.BlockOfReinforcedIron, 1), new Object[] {"III", "III", "III", 'I', new ItemStack(ModItems.reinforcedIronIngot)});

        // Tools
        craftManager.addRecipe(new ItemStack(ModItems.reinforcedAxe, 1), new Object[] {"BB", "BS", " S", 'B', new ItemStack(ModBlocks.BlockOfReinforcedIron), 'S', new ItemStack(ModItems.hardenedStick)});
        craftManager.addRecipe(new ItemStack(ModItems.reinforcedSword, 1), new Object[] {"B", "B", "S", 'B', new ItemStack(ModBlocks.BlockOfReinforcedIron), 'S', new ItemStack(ModItems.hardenedStick)});
        craftManager.addRecipe(new ItemStack(ModItems.reinforcedPick, 1), new Object[] {"BBB", " S ", " S ", 'B', new ItemStack(ModBlocks.BlockOfReinforcedIron), 'S', new ItemStack(ModItems.hardenedStick)});
        craftManager.addRecipe(new ItemStack(ModItems.reinforcedShovel, 1), new Object[] {"B", "S", "S", 'B', new ItemStack(ModBlocks.BlockOfReinforcedIron), 'S', new ItemStack(ModItems.hardenedStick)});
        craftManager.addRecipe(new ItemStack(ModItems.reinforcedHoe, 1), new Object[] {"BB", " S", " S", 'B', new ItemStack(ModBlocks.BlockOfReinforcedIron), 'S', new ItemStack(ModItems.hardenedStick)});
